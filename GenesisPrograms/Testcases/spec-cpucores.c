begin genesis
	...
	feature declarethreads
		value numthreads sample threaddist report(1)
		num_threads = ${numthreads};
	end

	generate 5 with dist1 = {1:10},numvardist = {2:8},epochdist = {1:5},compdist = {1:5},dist2 = {1:10;;real},threaddist={1:4}
end genesis
