begin genesis
	...
	program
		value numepochs enumerate epochdist
	...
	feature scope(enumerate) singleepoch
		${computation}
		${access}
	end

	feature allepochs
		genloop unrolling:1:numepochs
			singleepoch
			genif numepochs!=unrolling
				i = i + i_step;
			end
		end
	end
	...
	generate 3 notouch with dist1 = {1:10},numvardist = {2:8},epochdist = {1:5},dist2 = {1:10}
end genesis
