...
feature access
	...
	value CSE1 sample dist1 report(1)
	distribution insnsdist3={1:${CSE1}}
	
	value stride1 sample insnsdist3 noreplacement(1) report(1);stride3,stride5 sample insnsdist3 noreplacement(1) report(1)
...
generate 5 with dist1 = {1},numvardist = {2:8},epochdist = {1:5},compdist = {1:5},dist2 = {1:10}
end genesis
